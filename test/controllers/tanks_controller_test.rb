...
class TanksControllerTest < ActionController::TestCase
  ...
  test "should create tank" do
    assert_difference('Tank.count') do
      post :create, tank: { country_id: @tank.country_id, name: @tank.name, type_id: @tank.type_id, year: @tank.year }
    end
  ...
  test "should update tank" do
    patch :update, id: @tank, tank: { country_id: @tank.country_id, name: @tank.name, type_id: @tank.type_id, year: @tank.year }
    assert_redirected_to tank_path(assigns(:tank))
  end
